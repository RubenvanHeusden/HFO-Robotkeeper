...
./bin/HFO --trials 10000  --no-logging --no-sync --fullstate --seed 123 --port=6000 --offense-agents=1 --defense-agents=1 --ball-x-min=0.25 --ball-x-max=0.25 --ball-y-min=0.0 --ball-y-max=0.0 --offense-on-ball 11 &
