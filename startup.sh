...
sleep 10
python ./example/test_takers/intermediate_kicker.py --trials=$trials &
sleep 5
python ./example/test_keepers/fixed_keeper/fixed_agent.py --filename="models/transfer/model7_update_in_batches_target_network_fixed_states" --trials=$trials
sleep 10
